...
""",
    ...
    def get_skills(self, actor=None):
        if actor:
            ...
            result = {
                "Acrobatics": random.randint(-2, 9),
                "Animal Handling": random.randint(-2, 9),
                "Arcana": random.randint(-2, 9),
                "Athletics": random.randint(-2, 9),
                "Deception": random.randint(-2, 9),
                "History": random.randint(-2, 9),
                "Insight": random.randint(-2, 9),
                "Intimidation": random.randint(-2, 9),
                "Investigation": random.randint(-2, 9),
                "Medicine": random.randint(-2, 9),
                "Nature": random.randint(-2, 9),
                "Perception": random.randint(-2, 9),
                "Performance": random.randint(-2, 9),
                "Persuasion": random.randint(-2, 9),
                "Religion": random.randint(-2, 9),
                "Sleight of Hand": random.randint(-2, 9),
                "Stealth": random.randint(-2, 9),
                "Survival": random.randint(-2, 9),
            }
        # log(result)
        return result

...
"""
    ...
    def build_map_prompt(self):
        ...
        constraints = "TOP-DOWN ORTHOGRAPHIC PROJECTION. NO 3D perspective, NO isometric view, NO characters, NO text, NO UI. NO GRID, NO ICONS, NO SYMBOLS, NO SCALE BAR, NO LEGEND, NO WATERMARK, NO BORDER, MAP SPANS EDGE TO EDGE, NO TITLE, NO COMPASS ROSE, HIGH DETAIL LEVEL, VIVID COLORS, HIGH CONTRAST"
